...
bool test_is_tail() {
  if (!assert_true("snake tail", is_tail(SNAKE_TAIL[0]))) {
    return false;
  }
  if (!assert_true("snake tail", is_tail(SNAKE_TAIL[1]))) {
    return false;
  }
  if (!assert_true("snake tail", is_tail(SNAKE_TAIL[2]))) {
    return false;
  }
  if (!assert_true("snake tail", is_tail(SNAKE_TAIL[3]))) {
    return false;
  }
  printf("All is_tail tests passed!\n");
  return true;
}

bool test_is_snake() {
  if (!assert_true("snake body", is_snake(SNAKE_TAIL[0]))) {
    return false;
  }
  if (!assert_true("snake body", is_snake(SNAKE_TAIL[1]))) {
    return false;
  }
  if (!assert_true("snake body", is_snake(SNAKE_TAIL[2]))) {
    return false;
  }
  if (!assert_true("snake body", is_snake(SNAKE_TAIL[3]))) {
    return false;
  }
  if (!assert_true("snake body", is_snake(SNAKE_BODY[0]))) {
    return false;
  }
  if (!assert_true("snake body", is_snake(SNAKE_BODY[1]))) {
    return false;
  }
  if (!assert_true("snake body", is_snake(SNAKE_BODY[2]))) {
    return false;
  }
  if (!assert_true("snake body", is_snake(SNAKE_BODY[3]))) {
    return false;
  }
  if (!assert_true("snake body", is_snake(SNAKE_BODY[4]))) {
    return false;
  }
  printf("All is_snake tests passed!\n");
  return true;
}

bool test_body_to_tail() {
  if (!assert_equals_char("body to tail", SNAKE_TAIL[0], body_to_tail(SNAKE_BODY[0]))) {
    return false;
  }
  if (!assert_equals_char("body to tail", SNAKE_TAIL[1], body_to_tail(SNAKE_BODY[1]))) {
    return false;
  }
  if (!assert_equals_char("body to tail", SNAKE_TAIL[2], body_to_tail(SNAKE_BODY[2]))) {
    return false;
  }
  if (!assert_equals_char("body to tail", SNAKE_TAIL[3], body_to_tail(SNAKE_BODY[3]))) {
    return false;
  }
  printf("%s\n", "All test_body_to_tail tests passed!");
  return true;
}

bool test_incr_x() {
  if (!assert_equals_int("incr_x", 1, incr_x(SNAKE_BODY[3]))) {
    return false;
  }
  if (!assert_equals_int("incr_x", 1, incr_x(SNAKE_TAIL[3]))) {
    return false;
  }
  if (!assert_equals_int("incr_x", -1, incr_x(SNAKE_BODY[1]))) {
    return false;
  }
  if (!assert_equals_int("incr_x", -1, incr_x(SNAKE_TAIL[1]))) {
    return false;
  }
  if (!assert_equals_int("incr_x", 0, incr_x(SNAKE_BODY[0]))) {
    return false;
  }
  if (!assert_equals_int("incr_x", 0, incr_x(SNAKE_BODY[4]))) {
    return false;
  }
  if (!assert_equals_int("incr_x", 0, incr_x(SNAKE_TAIL[0]))) {
    return false;
  }
  printf("%s\n", "All test_incr_x tests passed!");
  return true;
}

bool test_incr_y() {
  if (!assert_equals_int("incr_y", 1, incr_y(SNAKE_BODY[2]))) {
    return false;
  }
  if (!assert_equals_int("incr_y", 1, incr_y(SNAKE_TAIL[2]))) {
    return false;
  }
  if (!assert_equals_int("incr_y", -1, incr_y(SNAKE_BODY[0]))) {
    return false;
  }
  if (!assert_equals_int("incr_y", -1, incr_y(SNAKE_TAIL[0]))) {
    return false;
  }
  if (!assert_equals_int("incr_y", 0, incr_y(SNAKE_BODY[1]))) {
   return false;
  }
  if (!assert_equals_int("incr_y", 0, incr_y(SNAKE_BODY[4]))) {
   return false;
  }
  if (!assert_equals_int("incr_y", 0, incr_y(SNAKE_TAIL[1]))) {
    return false;
  }
  printf("%s\n", "All test_incr_y tests passed!");
  return true;
}
